...
nudg.BuildBCMaps2D(Nfp,vmapM,BCType)

k,f = num.nonzero(BCType)
faces = num.vstack((k,f)).T
curved = num.sort(num.unique(k))
VX,VY,x,y,Fx,Fy,rx,ry,sx,sy,nx,ny,sJ, Fscale =\
        nudg.MakeCylinder2D(faces,1,0,0,VX,VY,EToV,r,s,x,y,Fmask,FmaskF,N,Dr,Ds,K)
